...
**FAIL — cart-merge banner (NSnackBar.show) never becomes visible live; mechanism (flag set/consume) correct but presentation broken**

**1 screenshot(s).** Click any thumbnail for full resolution.

<table>
<tr>
<td align="center" width="33%"><a href="bug-ac1-banner-not-rendered.png"><img src="bug-ac1-banner-not-rendered.png" width="240"></a><br><sub>bug ac1 banner not rendered</sub></td>
</tr>
</table>
